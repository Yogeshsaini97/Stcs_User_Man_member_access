...
const InvoicesUrl = `http://localhost:8080/o/c/invoices/?p_auth=${Liferay.authToken}&filter=r_withInvoice_c_projecttId eq '${ProjectApiId.value}'`;
    ...
    <div class="tab-pane " id="four" role="tabpanel" aria-labelledby="foue-tab">
        <div class="row">
          <div class="col-md-3 border-right">
            <h2 class="mt-4 line-height-15">Project<br />Invoices</h2>
            <div class="mt-4">
