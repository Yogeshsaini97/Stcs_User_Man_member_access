...
const ScheduleUrl = `http://localhost:8080/o/c/projectschedules/?p_auth=${Liferay.authToken}&filter=r_withSchedule_c_projecttId eq '${ProjectApiId.value}'`;
    ...
    <div class="tab-pane " id="eight" role="tabpanel" aria-labelledby="eight-tab">
        <div class="row">
          <div class="col-md-3 border-right">
            <h2 class="mt-4 line-height-15">Project<br />Schedule</h2>
            <div class="mt-4">
